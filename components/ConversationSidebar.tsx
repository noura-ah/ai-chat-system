...
export default function ConversationSidebar({
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed left-0 top-[70px] bottom-0 w-64 bg-white dark:bg-gray-800 border-r border-stone-200 dark:border-gray-700 z-40 transform transition-transform duration-300 ease-in-out ${
          isOpen ? 'translate-x-0' : '-translate-x-full'
        } lg:translate-x-0 flex flex-col`}
      >
        {/* Header */}
        <div className="p-4 border-b border-stone-200 dark:border-gray-700 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              <Plus className="w-5 h-5 text-stone-600 dark:text-gray-400" />
            </button>
            <button
              onClick={onClose}
              className="p-2 hover:bg-stone-100 dark:hover:bg-gray-700 rounded-lg transition-colors lg:hidden"
            >
        ...
        <div className="flex-1 overflow-y-auto">
          {isLoading ? (
            <div className="p-4 text-center text-stone-500 dark:text-gray-400">
              Loading...
            </div>
                ...
                <div
                  ...
                  className={`group relative p-3 rounded-lg mb-2 cursor-pointer transition-colors ${
                    currentConversationId === conversation.id
                      ? 'bg-stone-100 dark:bg-gray-700 dark:hover:bg-gray-600'
                      : 'hover:bg-stone-50 dark:hover:bg-gray-600'
                  }`}
                >
